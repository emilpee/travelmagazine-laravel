...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  created: function created() {
    ...
    var url = 'http://localhost/Travelmagazine/travelmagazine-laravel/public/articles/' + this.$route.params.id;
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  created: function created() {
    ...
    var url = 'http://localhost/Travelmagazine/travelmagazine-laravel/public/articles/';
    axios__WEBPACK_IMPORTED_MODULE_1___default.a.get(url).then(function (response) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  created: function created() {
    ...
    var url = 'http://localhost/Travelmagazine/travelmagazine-laravel/public/articles/' + this.$route.params.id + '/edit';
    axios__WEBPACK_IMPORTED_MODULE_1___default.a.get(url).then(function (response) {
      _this.article = response.data;
    });
  },
  methods: {
    updateArticle: function updateArticle() {
      ...
      var url = 'http://localhost/Travelmagazine/travelmagazine-laravel/public/articles/' + this.$route.params.id;
      axios__WEBPACK_IMPORTED_MODULE_1___default.a.put(url, this.article).then(function (response) {
        _this2.$router.push({
          name: 'Articles'
        });
      });
  ...
  return _c(
    ...
    [
      _c(
        ...
        {
          attrs: {
            to: { name: "EditArticle", params: { id: _vm.article.article_id } }
          }
        },
        [_vm._v("Edit")]
      ),
      ...
      _vm._v(" "),
      _c("h3", [_vm._v(_vm._s(_vm.article.lead))]),
      _vm._v(" "),
      _c("p", [_vm._v(_vm._s(_vm.article.bodytext))])
    ],
    1
  )
}
          ...
          directives: [
            {
              name: "model",
              rawName: "v-model",
              value: _vm.article.prio,
              expression: "article.prio"
            }
          ],
          attrs: { type: "number" },
          domProps: { value: _vm.article.prio },
          on: {
            input: function($event) {
              if ($event.target.composing) {
                return
              }
              _vm.$set(_vm.article, "prio", $event.target.value)
            }
          }
        }),
        _vm._v(" "),
          ...
          directives: [
            {
              name: "model",
              rawName: "v-model",
              value: _vm.article.lead,
              expression: "article.lead"
            }
          ],
          attrs: { rows: "10" },
          domProps: { value: _vm.article.lead },
          on: {
            input: function($event) {
              if ($event.target.composing) {
                return
              }
              _vm.$set(_vm.article, "lead", $event.target.value)
            }
          }
        }),
        _vm._v(" "),
          ...
          directives: [
            {
              name: "model",
              rawName: "v-model",
              value: _vm.article.bodytext,
              expression: "article.bodytext"
            }
          ],
          attrs: { rows: "30" },
          domProps: { value: _vm.article.bodytext },
          on: {
            input: function($event) {
              if ($event.target.composing) {
                return
              }
              _vm.$set(_vm.article, "bodytext", $event.target.value)
            }
          }
        }),
        _vm._v(" "),
          ...
          directives: [
            {
              name: "model",
              rawName: "v-model",
              value: _vm.article.img_url,
              expression: "article.img_url"
            }
          ],
          attrs: { type: "text" },
          domProps: { value: _vm.article.img_url },
          on: {
            input: function($event) {
              if ($event.target.composing) {
                return
              }
              _vm.$set(_vm.article, "img_url", $event.target.value)
            }
          }
        }),
        _vm._v(" "),
        _c("button", { attrs: { type: "submit" } }, [_vm._v("Spara")])
      ]
    )
  ])
}
...
/* harmony import */ var _components_Articles_vue__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/Articles.vue */ "./resources/js/components/Articles.vue");
/* harmony import */ var _components_Article_vue__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/Article.vue */ "./resources/js/components/Article.vue");
/* harmony import */ var _components_EditArticle_vue__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components/EditArticle.vue */ "./resources/js/components/EditArticle.vue");
...
var routes = [{
  ...
  component: _components_Articles_vue__WEBPACK_IMPORTED_MODULE_4__["default"]
}, {
  name: 'Article',
  path: '/Travelmagazine/travelmagazine-laravel/public/article/:id',
  component: _components_Article_vue__WEBPACK_IMPORTED_MODULE_5__["default"]
}, {
  name: 'EditArticle',
  path: '/Travelmagazine/travelmagazine-laravel/public/edit/:id',
  component: _components_EditArticle_vue__WEBPACK_IMPORTED_MODULE_6__["default"]
}];
